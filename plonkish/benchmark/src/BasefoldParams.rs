...
#[derive(Debug)]
pub struct TwentySeven8 {}
impl plonkish_backend::pcs::multilinear::BasefoldExtParams for TwentySeven8 {
    fn get_rate() -> usize {
        return 3;
    }
...
#[derive(Debug)]
pub struct TwentyEight8 {}
impl plonkish_backend::pcs::multilinear::BasefoldExtParams for TwentyEight8 {
    fn get_rate() -> usize {
        return 3;
    }
