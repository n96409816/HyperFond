...
use ff::PrimeField;
use plonkish_backend::{piop::sum_check::VirtualPolynomial, poly::multilinear::MultilinearPolynomial, util::{transcript::{FiatShamirTranscript, TranscriptWrite, TranscriptRead}, hash::Hash}, pcs::PolynomialCommitmentScheme};
use serde::de::DeserializeOwned;
use std::{fmt::Debug, sync::Arc};
use plonkish_backend::pcs::CommitmentChunk;
use deNetwork::{DeMultiNet as Net, DeNet, DeSerNet};
use serde::Serialize;
use serde::Deserialize;

use super::structs::VPAuxInfo;
    ...
    Self: Sized,
{
    ...
    /// over {0,1}^`num_vars`.
    fn prover_init(polynomial: Self::VirtualPolynomial<'_>) -> Result<Self, PolyIOPErrors>;
...
impl<F, Pcs> SumCheck<F> for PolyIOP<F, Pcs>
where 
    ...
    Pcs: PolynomialCommitmentScheme<F, Polynomial = MultilinearPolynomial<F>>,
{
    ...
    type VirtualPolynomial<'a> = VirtualPolynomial<'a, F>;
