...
use crate::poly_iop::{structs::{IOPProverState, IOPProverMessage}, errors::PolyIOPErrors};

use super::SumCheckProver;
use ff::PrimeField;
use ark_std::{cfg_into_iter, end_timer, start_timer, vec::Vec};
use plonkish_backend::{piop::sum_check::VirtualPolynomial, util::arithmetic::barycentric_weights};
use std::sync::Arc;

#[cfg(feature = "parallel")]
use rayon::iter::{IntoParallelRefMutIterator, ParallelIterator};

impl<F: PrimeField> SumCheckProver<F> for IOPProverState<'_, F> {
